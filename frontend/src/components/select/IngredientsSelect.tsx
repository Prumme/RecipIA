...
export function IngredientsSelect({
  ...
  useEffect(() => {
    ...
    // Debounce de 300ms avant de faire la requête
    ...
    // Cleanup: annule le timer précédent si l'utilisateur continue de taper
        ...
        {selectedIngredients.map((ingredient) => (
          ...
          >
            <img
              ...
              loading="lazy"
            />
            <span className="capitalize">{ingredient.food_name}</span>
